...
image1 = face_recognition.load_image_file(os.path.abspath("recognize/images/temp.jpg"))
image1_face_encoding = face_recognition.face_encodings(image1)[0]

#image2 = face_recognition.load_image_file(os.path.abspath("recognize/images/me1.jpg"))
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            name = "UnRegistered Vehicle Owner"
